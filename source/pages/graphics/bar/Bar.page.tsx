...
function Bar() {
      ...
      getNestLoops: ({
        ...
        return nestIndices.map((nestIndex, colorIndex) => {
          return {
            ...
            strokeColor: (rhythmIndex === 9 ? colorsB : colorsA)[colorIndex],
          }
        })
      },
    },
      ...
      getNestLoops: ({
        ...
        return nestIndices.map((nestIndex, colorIndex) => {
          return {
            ...
            strokeColor: (rhythmIndex === 8 ? ['reversedColorsB'] : colorsA)[
              colorIndex
            ],
          }
        })
  ...
  const decorationLoops: {
    ...
    .map<any>(({ key, rotatedLoop }, someIndex) => {
      ...
      switch (key) {
        ...
        case 'midTop':
          return getDefaultDecorationNest({
            ...
            nestTranslation: { x: -0.0, y: -0.0875 },
            nestRhythm: getFilteredRhythm({
              rhythmSequence: [
                getNaturalRhythm({
                  rhythmResolution: 24,
        ...
        case 'rightEar':
          return getDefaultDecorationNest({
            ...
            colorSequence: reversedColorsA,
            nestTranslation:
              key === 'leftEar' ? { x: -0.0, y: -0.1 } : { x: 0.0, y: -0.1 },
            nestRhythm: getFilteredRhythm({
              rhythmSequence: [
                getNaturalRhythm({
                  rhythmResolution: 24,
